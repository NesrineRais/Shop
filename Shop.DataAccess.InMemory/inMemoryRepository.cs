...
{
    public class inMemoryRepository<T> : IRepository<T> where T : BaseEntity //<T> pour dire classe généric et accepte tous type d'object
    {
        ...
        public inMemoryRepository()
        {
            ...
            items = cache[className] as List<T>; //création d un dictionnaire de type items
            //bonne pratique
            if (items == null)
            {
                items = new List<T>();
